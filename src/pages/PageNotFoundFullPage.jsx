...
function PageNotFoundFullPage() {
  return (
    <div className="flex h-screen flex-col justify-center overflow-hidden">
      <div className="mt-44 flex flex-col items-center gap-4 text-center font-extrabold text-primary-200 laptopS:gap-6">
...
export default PageNotFoundFullPage;
